...
import DownloadListDgem from './DownloadListDgem';
import axios from "axios";
import HeaderPdfStandardDg from "../Page/HeaderPdfStandardDg";
                    ...
                    <div className="nvl--two">
                        <section className="bd">
                            <div className="bodyone">
                                ...
                                </Link>} pagetitre={"Pdf Designer Graphique"}/>
                                <hr />
                            </div>
