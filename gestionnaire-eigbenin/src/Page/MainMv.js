...
import ListMv from "./MV/ListMv"
import Bod from "./Bod";
import BodyOne from "./BodyOne";
import axios from "axios";
import HeaderPdfStandardMv from "./HeaderPdfStandardMv";
...
export default class MainMv extends React.Component{
    ...
    getStudent(){
        let self = this;
        axios.get('http://localhost:8000/api/listmont')
        .then(response => {
            self.setState({
            ...
            <>
                <section className="nvl--style">
                    <div className="nvl--one">
                        <HeaderPdfStandardMv title={"Pdf Montage Video"} linkpdfmvc={"/pdf-download-mvc"}
                        linkpdfmvb={"/pdf-download-mvb"}
                        linkpdfmvem={"/pdf-download-mvem"}/>
                    </div>
                    <div className="nvl--two">
                        <section className="bd">
                            <div className="bodyone">
                                <BodyOne linkone={<Link to={"/ajoutmonteurvideo"} className="lie--tw">
                                ...
                                </Link>} pagetitre={"Montage Video/Cadrage"}/>
                                <hr />
                            </div>
                            ...
                            <div className="nvl--body">
                                <div className="pos">
                                    ...
                                    <div className="pos--two">
                                        <Bod corp={<ListMv handleStudentDelete={(id) => this.handleStudentDelete(id)} students={this.state.students} />} /> 
                                    </div>
                                </div>
                            </div>
                        </section>
